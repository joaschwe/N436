...
window.Modernizr = function (d, l, u) {
    ...
    var A = ["Webkit", "Moz", "O", "ms"], B = ["webkit", "moz", "o", "ms"], n = {}, a = [], c = a.slice, b,
        e = function (a, b, c, e) {
...
(function (d, l, u) {
    ...
    "$:nomunge";
    var p = "hashchange", g = document, s, n = d.event.special, z = g.documentMode,
        A = "on" + p in l && (z === u || 7 < z);
    d.fn[p] = function (d) {
...
(function (d) {
    ...
    l.prototype = {
        destroy: function () {
            ...
            var b = this.leftPageIndex(a), e = this.rightPageIndex(a),
                f = this.pageBelow(b), k = this.pageBelow(e), h = this.pageWidth, m = this.rtl,
                v = this.pages.length - 1, p, g;
            this.loadPage(b);
            this.loadPage(e);
            this.loadPage(f);
            this.loadPage(k);
            ...
            var c = this.pageWidth, b = this.pageHeight, e = c / 2, f = b / 2, k = d.wowBook.utils.translate,
                h = a.pageLeft, m = a.x, v = a.y, p = a.back, g = a.corner || "tl";
            if ("l" == g || "r" == g) {
                ...
                var q = m - t.x, r = v - t.y, q = Math.atan2(r, q), t = {x: 0, y: (v >= t.y ? 0 : b) - t.y},
            ...
            }), this.foldGradientElem.css("transform", k(-m + a.foldGradientWidth / 2, 0)), a.foldGradientVisible || (this.foldGradientContainer.css("display", "block"), a.foldGradientVisible = !0)) : a.foldGradientVisible && (this.foldGradientContainer.css("display", "none"), a.foldGradientVisible =
                !1)
        ...
        foldPageBasicStart: function (a, c, b, e, d) {
            ...
            if (a !== this.zoomLevel) {
                this.zoomLevel = a;
                var e = this, c = this.zoomWindow, b = this.zoomContent, f = d(this.zoomBoundingBox),
                    k = 2 * e.pageWidth *
                        a * this.currentScale, h = e.pageHeight * a * this.currentScale, g = f.width(), p = f.height(),
                    l = Math.min(k, g), n = Math.min(h, p), s = (2 * this.pageWidth * this.currentScale - l) / 2,
            ...
            if (this.zoomContentOverflowed) {
                ...
                var f = this.zoomWindow.width(), b = 2 * this.pageWidth *
                    c * this.currentScale - f, d = d / f, f = this.zoomWindow.height(),
        ...
        positionBookShadow: function () {
            ...
            if (c) {
                var c = this.pageWidth, b = this.holdedPageBack,
            ...
            if (!this.curledPage && !this.holdedPage) {
                ...
                if (a && !a.isCurled) {
                    a.isCurled = !0;
                    this.curledPage = a;
                    var b = this.pageIsOnTheLeft(a.pageIndex), d = b ? 0 : this.pageWidth,
        ...
        thumbnailConfig: function () {
            ...
            var b = this.opts.thumbnailsVertical, d = b ? "height" : "width", f = {}, g = this.thumbnailsClipper[d](),
            ...
            if (this.thumbnails && this.thumbnailsContainer.is(":visible")) {
                ...
                var b = this.opts.thumbnailsVertical, d = b ? "top" : "left", f = b ? "height" : "width",
                    g = this.thumbnails[a], h = this.thumbnailsClipper, b = h[f]() / 2 - g[f]() / (b ? 2 : 1),
    ...
    var g = d.browser.msie && 9 > d.browser.version ? 1 : 0, s = {thin: 2 - g, medium: 4 - g, thick: 6 - g},
        n = window.document, z = n.documentElement,
        A = z.requestFullscreen || z.mozRequestFullScreen || z.webkitRequestFullscreen || z.msRequestFullscreen,
        B = n.exitFullscreen || n.mozCancelFullScreen || n.webkitExitFullscreen ||
            n.msExitFullscreen;
    d.wowBook.utils = {
